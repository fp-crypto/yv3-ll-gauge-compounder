...
/// @title OneUpGaugeCompounderStrategyFactory
/// @notice Factory contract for deploying 1UP Liquid Locker gauge compounder strategies
/// @dev Extends BaseLLGaugeCompounderStrategyFactory to create 1UP-specific strategies
contract OneUpGaugeCompounderStrategyFactory is
    BaseLLGaugeCompounderStrategyFactory
{
    ...
    /// @notice Deploys a new 1UP strategy for a given yVault
    ...
    /// @return address Address of the newly deployed 1UP strategy
